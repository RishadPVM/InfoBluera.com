        ...
        <div className="min-h-screen bg-gradient-to-b from-[#040718] to-[#0a0f2e] text-white overflow-hidden">
            ...
            >
                <motion.div variants={itemVariants} className="mb-16">
                    ...
                    <div className="h-1 w-40 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full" />
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="mb-16">
                    <h2 className="text-3xl font-bold mb-12 text-white border-b border-purple-500/30 pb-4">
                        Case Study
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {[
                            ...
                            <motion.div
                                key={index}
                                whileHover={{ x: 10 }}
                                className="flex items-center gap-4 p-6 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-xl border border-purple-500/20 hover:border-pink-500/40 transition-all duration-300"
                            >
                    ...
                    <div className="flex flex-wrap gap-4">
                        {["Flutter", "Web Technologies", "Backend Integration"].map((tech, index) => (
                            <motion.div
                                ...
                                className="px-6 py-3 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-lg font-semibold text-white hover:border-pink-500/50 hover:shadow-lg hover:shadow-pink-500/20 transition-all duration-300"
                            >
                                {tech}
                            </motion.div>
                        ))}
                ...
                <motion.div variants={itemVariants} className="mt-20 pt-12 border-t border-purple-500/20">
                    <div className="flex flex-col md:flex-row gap-6 justify-center md:justify-start">
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg font-semibold text-white hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300"
                        >
                            View Live Project
                        </motion.button>
                        <motion.button
