        ...
        <div className="min-h-screen bg-gradient-to-b from-[#040718] to-[#0a0f2e] text-white overflow-hidden">
            ...
            >
                ...
                <motion.div variants={itemVariants} className="mb-12 md:mb-16">
                    <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent">
                        Niska
                    </h1>
                    <p className="text-xl sm:text-2xl md:text-3xl text-cyan-400 font-semibold mb-6">
                        Delivery & Inventory Management Mobile Application
                    </p>
                    <div className="h-1 w-24 md:w-40 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full" />
                </motion.div>
                ...
                {/* Case Study Section */}
                <motion.div variants={itemVariants} className="mb-12 md:mb-16">
                    <h2 className="text-2xl md:text-3xl font-bold mb-8 md:mb-12 text-white border-b border-blue-500/30 pb-4">
                        Case Study
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        {[
                            ...
                            <motion.div
                                key={index}
                                whileHover={{ x: 10 }}
                                className="flex items-center gap-4 p-4 md:p-6 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-xl border border-blue-500/20 hover:border-cyan-500/40 transition-all duration-300"
                            >
                    ...
                    <div className="flex flex-wrap gap-3 md:gap-4">
                        {[
                            ...
                            <motion.div
                                ...
                                className="px-4 py-2 md:px-6 md:py-3 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-lg font-semibold text-white hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 text-sm md:text-base"
                            >
                                {tech}
                            </motion.div>
                        ))}
                ...
                {/* CTA Section */}
                <motion.div variants={itemVariants} className="mt-12 md:mt-20 pt-12 border-t border-blue-500/20">
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 justify-center md:justify-start">
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="px-6 py-3 md:px-8 md:py-4 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg font-semibold text-white hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 text-sm md:text-base text-center"
                        >
                            View Live Project
                        </motion.a>
                        <motion.a
                            ...
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="px-6 py-3 md:px-8 md:py-4 border border-blue-500 text-blue-400 rounded-lg font-semibold hover:bg-blue-500/10 transition-all duration-300 text-sm md:text-base text-center"
                        >
                            Contact Us
                        </motion.a>
                    </div>
